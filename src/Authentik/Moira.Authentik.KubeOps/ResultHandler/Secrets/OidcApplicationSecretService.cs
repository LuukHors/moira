    ...
    ILogger<OidcApplicationSecretService> logger) : IOidcApplicationSecretService
{
    ...
    public async Task<IEnumerable<AuthentikOidcApplication.SecretStatus>> SyncAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        var statuses = new List<AuthentikOidcApplication.SecretStatus>();
    ...
    public async Task DeleteAsync(AuthentikOidcApplication entity, CancellationToken cancellationToken)
    {
    ...
    private static SecretTarget SourceTarget(AuthentikOidcApplication entity, AuthentikOidcApplicationModel? idpEntity = null)
    {
    ...
    private static SecretTarget ToSecretTarget(
        AuthentikOidcApplication entity,
        AuthentikOidcApplication.Secret secret,
        AuthentikOidcApplicationModel? idpEntity = null)
    {
    ...
    private static string RenderTemplate(string template, AuthentikOidcApplicationModel idpEntity)
    {
        return template
    ...
    private static AuthentikOidcApplication.SecretStatus ToOidcStatus(SecretTargetStatus status)
    {
        return new AuthentikOidcApplication.SecretStatus
        {
            Name = status.Name,
    ...
    private static AuthentikOidcApplication.SecretStatus ToFailedOidcStatus(
        SecretTarget target,
        Exception exception,
    ...
    private static AuthentikOidcApplication? OwnerReferenceFor(
        AuthentikOidcApplication entity,
    ...
    private static string SecretStatusKey(AuthentikOidcApplication.SecretStatus status)
    {
    ...
    private static bool TryToSecretTarget(
        AuthentikOidcApplication.SecretStatus status,
    ...
    private static AuthentikOidcApplication.ClusterSecretRef? ToOidcClusterRef(ClusterSecretRef? clusterRef)
    {
        ...
        return new AuthentikOidcApplication.ClusterSecretRef
        { 
    ...
    private static ClusterSecretRef? ToClusterRef(AuthentikOidcApplication.ClusterSecretRef? clusterRef)
    {
        if (clusterRef is null)
        {
            return null;
